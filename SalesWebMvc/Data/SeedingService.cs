...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()  //ESSA OPERACAO É RESPONSAVEL POR POPULAR MINHA BASE DE DADOS
        {
            ...
            SalesRecord r9 = new SalesRecord(new DateTime(2018, 09, 14), 11000.0, SaleStatus.PEDDING, s6);
            ...
            SalesRecord r12 = new SalesRecord(new DateTime(2018, 09, 25), 7000.0, SaleStatus.PEDDING, s3);
            ...
            //Adicionando esses objetos no banco
            ...
            _context.SaveChanges(); //Essa operacao salva e confirma as alteracoes no banco de dados
        }
